...
/**
 * DNS nodes can be used to specify an individual DNS query or the key to a
 * specific result.
 * Each node represents a fully-qualified domain name (represented by hostName)
 * and a record
...
public class DNSNode implements Comparable<DNSNode>, Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!hostName.equals(dnsNode.hostName))
            return false;
